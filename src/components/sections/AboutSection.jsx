  ...
  return (
    <section id="about" className="py-20 bg-transparent transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-display font-bold text-slate-900 dark:text-white mb-4 text-glow">About Me</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative max-w-md lg:max-w-lg w-full">
              <div className="absolute inset-0 bg-primary-500 rounded-2xl transform translate-x-6 translate-y-6 opacity-20"></div>
              <img 
                src="/3d_dev_avatar.png" 
                alt="3D Developer" 
                className="rounded-2xl relative z-10 w-full h-auto object-cover shadow-2xl"
              />
            </div>
          </motion.div>
          ...
          >
            <h3 className="text-2xl font-bold text-slate-800 dark:text-slate-100 mb-4">
              Data Enthusiast & Frontend Developer based in Hyderabad, Telangana, India.
            </h3>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="p-4 glass-premium rounded-lg">
                <h4 className="text-primary-500 font-bold text-3xl mb-1 text-glow">8.77</h4>
                <p className="text-slate-600 dark:text-slate-400 font-medium">B.Tech GPA</p>
              </div>
              <div className="p-4 glass-premium rounded-lg">
                <h4 className="text-primary-500 font-bold text-3xl mb-1 text-glow">3+</h4>
                <p className="text-slate-600 dark:text-slate-400 font-medium">Core Projects</p>
              </div>
              <div className="p-4 glass-premium rounded-lg">
                <h4 className="text-primary-500 font-bold text-3xl mb-1 text-glow">5+</h4>
                <p className="text-slate-600 dark:text-slate-400 font-medium">Industry Certs</p>
              </div>
              <div className="p-4 glass-premium rounded-lg">
                <h4 className="text-primary-500 font-bold text-3xl mb-1 text-glow">2+</h4>
