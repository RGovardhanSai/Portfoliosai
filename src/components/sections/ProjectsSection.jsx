...
const projects = [
  {
    ...
    image: '/facial_gesture_project.png',
    tech: ['Python', 'OpenCV', 'Dlib', 'PyAutoGUI', 'Mediapipe'],
    github: 'https://github.com/RGovardhanSai/facial-gesture-mouse-control',
    live: '#',
  },
  {
    id: 2,
    ...
    image: '/sales_dashboard_project.png',
    tech: ['Python', 'Power BI', 'Excel', 'Pandas', 'Matplotlib'],
    github: 'https://github.com/RGovardhanSai/sales-data-analysis',
    live: '#',
  },
  {
    id: 3,
    ...
    image: '/fraud_detection_project.png',
    tech: ['Python', 'Pandas', 'NumPy', 'Matplotlib', 'Scikit-Learn'],
    github: 'https://github.com/RGovardhanSai/bank-fraud-detection',
    live: '#',
  }
];
  ...
  return (
    <section id="projects" className="py-20 bg-transparent transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-display font-bold text-slate-900 dark:text-white mb-4 text-glow">Featured Projects</h2>
          ...
          {projects.map((project, index) => (
            <Tilt key={project.id} tiltMaxAngleX={5} tiltMaxAngleY={5} scale={1.02} transitionSpeed={2000} className="h-full">
              <motion.div
                ...
                className="glass-premium rounded-2xl overflow-hidden shadow-lg hover:-translate-y-2 transition-transform duration-300 flex flex-col h-full transform-style-3d"
              >
